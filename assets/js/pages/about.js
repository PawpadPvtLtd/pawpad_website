...
// Uploaded photos have a full web address (https://api.pawpad.in/...); older content
// may hold just a file name from assets/img/pawpad/.
function aboutImageSrc(img) {
  const value = String(img || "");
  return /^(assets\/|https?:\/\/|data:|\/)/.test(value) ? value : `assets/img/pawpad/${value}`;
}
function AboutHero() {
