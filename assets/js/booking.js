...
function StepCourseEnquiry({ data, upd }) {
  return /* @__PURE__ */ React.createElement("div", { className: "step" }, /* @__PURE__ */ React.createElement("p", { className: "eyebrow" }, "Course Enquiry"), /* @__PURE__ */ React.createElement("h2", { className: "b-step-title" }, "Tell us where to reach you"), /* @__PURE__ */ React.createElement("p", { className: "b-step-sub" }, "No grooming questions here. Share your details and the Pawpad team will help you with course dates, batch availability, and next steps."), /* @__PURE__ */ React.createElement("div", { className: "b-grid-2", style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Your name"), /* @__PURE__ */ React.createElement("input", { value: data.name, onChange: (e) => upd("name", e.target.value), placeholder: "Your name" })), /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Phone Number"), /* @__PURE__ */ React.createElement("input", { type: "tel", value: data.phone, onChange: (e) => upd("phone", e.target.value), placeholder: "98765 43210" }))), /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Email id"), /* @__PURE__ */ React.createElement("input", { type: "email", value: data.email, onChange: (e) => upd("email", e.target.value), placeholder: "you@example.com" })));
}
function StepBoardingEnquiry({ data, upd }) {
  return /* @__PURE__ */ React.createElement("div", { className: "step" }, /* @__PURE__ */ React.createElement("p", { className: "eyebrow" }, "Boarding Enquiry"), /* @__PURE__ */ React.createElement("h2", { className: "b-step-title" }, "A few details for the trial day"), /* @__PURE__ */ React.createElement("p", { className: "b-step-sub" }, "Share your details and preferred stay dates. We'll get in touch with you shortly."), /* @__PURE__ */ React.createElement("div", { className: "b-grid-2", style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Name"), /* @__PURE__ */ React.createElement("input", { value: data.name, onChange: (e) => upd("name", e.target.value), placeholder: "Your name" })), /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Breed"), /* @__PURE__ */ React.createElement("input", { value: data.breed, onChange: (e) => upd("breed", e.target.value), placeholder: "e.g. Indie / Beagle" }))), /* @__PURE__ */ React.createElement("div", { className: "b-grid-2", style: { marginBottom: 18 } }, /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Email"), /* @__PURE__ */ React.createElement("input", { type: "email", value: data.email, onChange: (e) => upd("email", e.target.value), placeholder: "you@example.com" })), /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Phone Number"), /* @__PURE__ */ React.createElement("input", { type: "tel", value: data.phone, onChange: (e) => upd("phone", e.target.value), placeholder: "98765 43210" }))), /* @__PURE__ */ React.createElement("div", { className: "b-grid-2" }, /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Date - From"), /* @__PURE__ */ React.createElement("input", { type: "date", value: data.dateFrom, onChange: (e) => upd("dateFrom", e.target.value) })), /* @__PURE__ */ React.createElement("div", { className: "field" }, /* @__PURE__ */ React.createElement("label", null, "Date - To"), /* @__PURE__ */ React.createElement("input", { type: "date", value: data.dateTo, onChange: (e) => upd("dateTo", e.target.value) }))));
}
